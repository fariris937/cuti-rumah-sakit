...
<?php $__env->startSection('title', 'Pengajuan Ijin'); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card p-3">
                ...
                <form action="<?php echo e(route('ijin.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <p>Bersama ini saya laporkan,</p>
                    <div class="row mb-2">
                        <div class="col-3">Nama</div>
                        <div class="col-9">: <?php echo e($user->nama); ?></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-3">Divisi/Jabatan</div>
                        <div class="col-9">: <?php echo e($user->divisi ? $user->divisi->nama_divisi ?? $user->divisi : '-'); ?></div>
                    </div>
                    <div class="row mb-2">
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  placeholder="Jelaskan alasan pengajuan ijin..."><?php echo e(old('keterangan')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\farir\cuti-rumah-sakit\resources\views/kepala_ruangan/ijin/create.blade.php ENDPATH**/ ?>