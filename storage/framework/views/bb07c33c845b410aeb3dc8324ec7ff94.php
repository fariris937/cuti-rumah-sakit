...
<body>
            ...
            <tr>
                ...
                <td>
                    <?php if($cuti->disetujui_oleh_kepala_bagian): ?>
                        <?php echo e($cuti->disetujuiOlehKepalaBagian->nama ?? '-'); ?>

                    <?php elseif($cuti->disetujui_oleh_kepala_ruangan): ?>
                        <?php echo e($cuti->disetujuiOlehKepalaRuangan->nama ?? '-'); ?>
    ...
    <p><strong>Total Cuti:</strong> <?php echo e($total_leaves); ?></p>
    <p><strong>Total Hari Cuti:</strong> <?php echo e($total_days); ?></p>
...
<?php /**PATH C:\Users\farir\cuti-rumah-sakit\resources\views/kepala_kepegawaian/pdf/monthly_report.blade.php ENDPATH**/ ?>