...
@section('title', 'Pengajuan Ijin - Kepala Bagian')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card p-3">
                ...
                <form action="{{ route('kepala-bagian.ijin.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <p>Bersama ini saya laporkan,</p>
                    <div class="row mb-2">
                        <div class="col-3">Nama</div>
                        <div class="col-9">: {{ $kepalaBagian->nama }}</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                  ...
                                  placeholder="Jelaskan alasan pengajuan ijin..." required>{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('kepala-bagian.dashboard') }}" class="btn btn-secondary">
